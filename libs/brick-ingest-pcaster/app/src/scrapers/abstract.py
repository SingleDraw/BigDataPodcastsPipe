...
class AbstractScraper:
    ...
    def _load_page(
        ...
        Validate.non_empty_string(goto_url, "goto_url")
        Validate.non_empty_string(wait_for_selector, "wait_for_selector")
        Validate.non_empty_string(wait_until, "wait_until")
